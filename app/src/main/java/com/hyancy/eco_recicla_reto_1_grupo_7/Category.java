...
public class Category extends AppCompatActivity {
    ...
    private ArrayList<Intent> initIntents() {
        ...
        Intent intentRegistroResiduos = new Intent(Category.this, FormularioRegistroResiduo.class);
        Intent intentEstadisticas = new Intent(Category.this, Statistic.class);
        Intent intentConsejos = new Intent(Category.this, Consejos.class);
        Intent intentLogout= new Intent(Category.this, MainActivity.class);
